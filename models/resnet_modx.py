...
from activations import MirrorActivationUnit
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100, input_channels=3):
        super().__init__()
    ...
    def forward(self, x):
        ...
        flat_features = output.view(output.size(0), -1)
